...
function itg_em_admin_attendee_list($start = 0) {
    ...
    $attendee_list = $wpdb->get_results($wpdb->prepare("SELECT * FROM {$itg_em_db_table_name['reg_table']} WHERE user_apply=%d", 1));
...
function itg_em_admin_attendee_approved_list($start = 0) {
    ...
    $attendee_list = $wpdb->get_results($wpdb->prepare("SELECT * FROM {$itg_em_db_table_name['reg_table']} WHERE pay_status=%d AND user_apply=%d", 1, 0));
...
function itg_em_admin_attendee_cancel_list($start = 0) {
    ...
    $attendee_list = $wpdb->get_results($wpdb->prepare("SELECT * FROM {$itg_em_db_table_name['reg_table']} WHERE pay_status=%d AND user_apply=%d", 0, 0));
