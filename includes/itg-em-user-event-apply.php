...
<div class="ui-widget">
        <div class="ui-state-highlight ui-corner-all" style="margin: 20px 0; padding: 0 .7em;"> 
                ...
                <strong>Done!</strong> Your Application has been enrolled. <a href="admin.php?page=itg_em_user_app_status_page&pmode=edit&item_id=<?php echo $wpdb->insert_id; ?>" class="button-secondary">View Status</a></p>
        </div>
</div>
                                    <?php
