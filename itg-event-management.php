...
Plugin URI: http://www.intechgrity.com/
...
function itg_em_admin_menu_hook() {
    ...
    /** Get All app details */
    $itg_em_admin_page[] = add_submenu_page('itg_event_admin', 'Get Printable Tabular data of registration', 'Print Registration', 'itg_em_cap_admin', 'itg_event_admin_list_atd', 'itg_em_admin_menu_list_atd');
...
function itg_em_user_menu_hook() {
    ...
    /** App status */
    $itg_em_user_page[] = add_submenu_page('itg_em_user_page', 'Edit or View your Application', 'Application Status <span class="update-plugins count-' . $num_app . '"><span class="plugin-count">' . $num_app . '</span></span>', 'itg_em_cap_subs', 'itg_em_user_app_status_page', 'itg_em_user_app_status');
