...
Check the Installation and FAQ page. Detail documentation coming soon.
...
**This is 0.9.9RC2 second Release Candidate. After the first RC, I have fixed some bugs and hope to be done with the plugin, but I will see how it goes for my own college and will fix any further bug if encountered. Then it will be set to public release**
